...
// SampleV1alpha1Client is used to interact with features provided by the sample.felipe1496.github.com group.
type SampleV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SampleV1alpha1Client) Databases(namespace string) DatabaseInterface {
